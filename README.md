...
| 📚 **Book Outline** | Bestseller-shaped chapter structures — diverse picture book, middle-grade adventure, romance beat sheet, YA coming-of-age, nonfiction/self-help — with representation-forward guidance baked into the picture-book template. Feeds into Audiobook Studio and Book Cover Studio. |
...
| 📖 **Book Cover Studio** | Front cover art for ebooks and print — title/author text baked in, correct Kindle/print/square shapes, your character's turnaround sheet for a consistent look. Pairs with Amazon KDP's free Cover Creator for the full print wrap (spine width needs your exact page count). |
